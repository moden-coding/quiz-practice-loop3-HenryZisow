...
public class App {
    public static void main(String[] args) throws Exception {
        ...
        int pass = 0;
        int fail = 0;
        System.out.println("Input your grades as integers:");
        while (true) {
            ...
            if (score == -1) {
                ...
                if (score <= 0 || score >= 100) {
                    System.out.println("Invalid number. Please input a different value:");
                } else {
                    if (score < 60) {
                        fail++;
                    } else {
        ...
        System.out.println("You have " + pass + " passing grades.");
        System.out.println("You have " + fail + " failing grades.");
    }
}
